...
void main() {
	...
	#include <colorspace_fragment>
	#include <fog_fragment>
}`},X={common:{diffuse:{value:new q(16777215)},opacity:{value:1},map:{value:null},mapTransform:{value:new G},alphaMap:{value:null},alphaMapTransform:{value:new G},alphaTest:{value:0}},specularmap:{specularMap:{value:null},specularMapTransform:{value:new G}},envmap:{envMap:{value:null},envMapRotation:{value:new G},flipEnvMap:{value:-1},reflectivity:{value:1},ior:{value:1.5},refractionRatio:{value:.98}},aomap:{aoMap:{value:null},aoMapIntensity:{value:1},aoMapTransform:{value:new G}},lightmap:{lightMap:{value:null},lightMapIntensity:{value:1},lightMapTransform:{value:new G}},bumpmap:{bumpMap:{value:null},bumpMapTransform:{value:new G},bumpScale:{value:1}},normalmap:{normalMap:{value:null},normalMapTransform:{value:new G},normalScale:{value:new U(1,1)}},displacementmap:{displacementMap:{value:null},displacementMapTransform:{value:new G},displacementScale:{value:1},displacementBias:{value:0}},emissivemap:{emissiveMap:{value:null},emissiveMapTransform:{value:new G}},metalnessmap:{metalnessMap:{value:null},metalnessMapTransform:{value:new G}},roughnessmap:{roughnessMap:{value:null},roughnessMapTransform:{value:new G}},gradientmap:{gradientMap:{value:null}},fog:{fogDensity:{value:25e-5},fogNear:{value:1},fogFar:{value:2e3},fogColor:{value:new q(16777215)}},lights:{ambientLightColor:{value:[]},lightProbe:{value:[]},directionalLights:{value:[],properties:{direction:{},color:{}}},directionalLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},directionalShadowMap:{value:[]},directionalShadowMatrix:{value:[]},spotLights:{value:[],properties:{color:{},position:{},direction:{},distance:{},coneCos:{},penumbraCos:{},decay:{}}},spotLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},spotLightMap:{value:[]},spotShadowMap:{value:[]},spotLightMatrix:{value:[]},pointLights:{value:[],properties:{color:{},position:{},decay:{},distance:{}}},pointLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{},shadowCameraNear:{},shadowCameraFar:{}}},pointShadowMap:{value:[]},pointShadowMatrix:{value:[]},hemisphereLights:{value:[],properties:{direction:{},skyColor:{},groundColor:{}}},rectAreaLights:{value:[],properties:{color:{},position:{},width:{},height:{}}},ltc_1:{value:null},ltc_2:{value:null}},points:{diffuse:{value:new q(16777215)},opacity:{value:1},size:{value:1},scale:{value:1},map:{value:null},alphaMap:{value:null},alphaMapTransform:{value:new G},alphaTest:{value:0},uvTransform:{value:new G}},sprite:{diffuse:{value:new q(16777215)},opacity:{value:1},center:{value:new U(.5,.5)},rotation:{value:0},map:{value:null},mapTransform:{value:new G},alphaMap:{value:null},alphaMapTransform:{value:new G},alphaTest:{value:0}}},ja={basic:{uniforms:ei([X.common,X.specularmap,X.envmap,X.aomap,X.lightmap,X.fog]),vertexShader:Y.meshbasic_vert,fragmentShader:Y.meshbasic_frag},lambert:{uniforms:ei([X.common,X.specularmap,X.envmap,X.aomap,X.lightmap,X.emissivemap,X.bumpmap,X.normalmap,X.displacementmap,X.fog,X.lights,{emissive:{value:new q(0)}}]),vertexShader:Y.meshlambert_vert,fragmentShader:Y.meshlambert_frag},phong:{uniforms:ei([X.common,X.specularmap,X.envmap,X.aomap,X.lightmap,X.emissivemap,X.bumpmap,X.normalmap,X.displacementmap,X.fog,X.lights,{emissive:{value:new q(0)},specular:{value:new q(1118481)},shininess:{value:30}}]),vertexShader:Y.meshphong_vert,fragmentShader:Y.meshphong_frag},standard:{uniforms:ei([X.common,X.envmap,X.aomap,X.lightmap,X.emissivemap,X.bumpmap,X.normalmap,X.displacementmap,X.roughnessmap,X.metalnessmap,X.fog,X.lights,{emissive:{value:new q(0)},roughness:{value:1},metalness:{value:0},envMapIntensity:{value:1}}]),vertexShader:Y.meshphysical_vert,fragmentShader:Y.meshphysical_frag},toon:{uniforms:ei([X.common,X.aomap,X.lightmap,X.emissivemap,X.bumpmap,X.normalmap,X.displacementmap,X.gradientmap,X.fog,X.lights,{emissive:{value:new q(0)}}]),vertexShader:Y.meshtoon_vert,fragmentShader:Y.meshtoon_frag},matcap:{uniforms:ei([X.common,X.bumpmap,X.normalmap,X.displacementmap,X.fog,{matcap:{value:null}}]),vertexShader:Y.meshmatcap_vert,fragmentShader:Y.meshmatcap_frag},points:{uniforms:ei([X.points,X.fog]),vertexShader:Y.points_vert,fragmentShader:Y.points_frag},dashed:{uniforms:ei([X.common,X.fog,{scale:{value:1},dashSize:{value:1},totalSize:{value:2}}]),vertexShader:Y.linedashed_vert,fragmentShader:Y.linedashed_frag},depth:{uniforms:ei([X.common,X.displacementmap]),vertexShader:Y.depth_vert,fragmentShader:Y.depth_frag},normal:{uniforms:ei([X.common,X.bumpmap,X.normalmap,X.displacementmap,{opacity:{value:1}}]),vertexShader:Y.meshnormal_vert,fragmentShader:Y.meshnormal_frag},sprite:{uniforms:ei([X.sprite,X.fog]),vertexShader:Y.sprite_vert,fragmentShader:Y.sprite_frag},background:{uniforms:{uvTransform:{value:new G},t2D:{value:null},backgroundIntensity:{value:1}},vertexShader:Y.background_vert,fragmentShader:Y.background_frag},backgroundCube:{uniforms:{envMap:{value:null},flipEnvMap:{value:-1},backgroundBlurriness:{value:0},backgroundIntensity:{value:1},backgroundRotation:{value:new G}},vertexShader:Y.backgroundCube_vert,fragmentShader:Y.backgroundCube_frag},cube:{uniforms:{tCube:{value:null},tFlip:{value:-1},opacity:{value:1}},vertexShader:Y.cube_vert,fragmentShader:Y.cube_frag},equirect:{uniforms:{tEquirect:{value:null}},vertexShader:Y.equirect_vert,fragmentShader:Y.equirect_frag},distanceRGBA:{uniforms:ei([X.common,X.displacementmap,{referencePosition:{value:new W},nearDistance:{value:1},farDistance:{value:1e3}}]),vertexShader:Y.distanceRGBA_vert,fragmentShader:Y.distanceRGBA_frag},shadow:{uniforms:ei([X.lights,X.fog,{color:{value:new q(0)},opacity:{value:1}}]),vertexShader:Y.shadow_vert,fragmentShader:Y.shadow_frag}};ja.physical={uniforms:ei([ja.standard.uniforms,{clearcoat:{value:0},clearcoatMap:{value:null},clearcoatMapTransform:{value:new G},clearcoatNormalMap:{value:null},clearcoatNormalMapTransform:{value:new G},clearcoatNormalScale:{value:new U(1,1)},clearcoatRoughness:{value:0},clearcoatRoughnessMap:{value:null},clearcoatRoughnessMapTransform:{value:new G},dispersion:{value:0},iridescence:{value:0},iridescenceMap:{value:null},iridescenceMapTransform:{value:new G},iridescenceIOR:{value:1.3},iridescenceThicknessMinimum:{value:100},iridescenceThicknessMaximum:{value:400},iridescenceThicknessMap:{value:null},iridescenceThicknessMapTransform:{value:new G},sheen:{value:0},sheenColor:{value:new q(0)},sheenColorMap:{value:null},sheenColorMapTransform:{value:new G},sheenRoughness:{value:1},sheenRoughnessMap:{value:null},sheenRoughnessMapTransform:{value:new G},transmission:{value:0},transmissionMap:{value:null},transmissionMapTransform:{value:new G},transmissionSamplerSize:{value:new U},transmissionSamplerMap:{value:null},thickness:{value:0},thicknessMap:{value:null},thicknessMapTransform:{value:new G},attenuationDistance:{value:0},attenuationColor:{value:new q(0)},specularColor:{value:new q(1,1,1)},specularColorMap:{value:null},specularColorMapTransform:{value:new G},specularIntensity:{value:1},specularIntensityMap:{value:null},specularIntensityMapTransform:{value:new G},anisotropyVector:{value:new U},anisotropyMap:{value:null},anisotropyMapTransform:{value:new G}}]),vertexShader:Y.meshphysical_vert,fragmentShader:Y.meshphysical_frag};var Ma={r:0,b:0,g:0},Na=new Ln,Pa=new Dn;function Fa(e,t,n,r,i,a,o){let s=new q(0),c=a===!0?0:1,l,u,d=null,f=0,p=null;function m(e){let r=e.isScene===!0?e.background:null;return r&&r.isTexture&&(r=(e.backgroundBlurriness>0?n:t).get(r)),r}function h(t){let n=!1,i=m(t);i===null?_(s,c):i&&i.isColor&&(_(i,1),n=!0);let a=e.xr.getEnvironmentBlendMode();a===`additive`?r.buffers.color.setClear(0,0,0,1,o):a===`alpha-blend`&&r.buffers.color.setClear(0,0,0,0,o),(e.autoClear||n)&&(r.buffers.depth.setTest(!0),r.buffers.depth.setMask(!0),r.buffers.color.setMask(!0),e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil))}function g(t,n){let r=m(n);r&&(r.isCubeTexture||r.mapping===306)?(u===void 0&&(u=new Yr(new Qr(1,1,1),new oi({name:`BackgroundCubeMaterial`,uniforms:$r(ja.backgroundCube.uniforms),vertexShader:ja.backgroundCube.vertexShader,fragmentShader:ja.backgroundCube.fragmentShader,side:1,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),u.geometry.deleteAttribute(`normal`),u.geometry.deleteAttribute(`uv`),u.onBeforeRender=function(e,t,n){this.matrixWorld.copyPosition(n.matrixWorld)},Object.defineProperty(u.material,`envMap`,{get:function(){return this.uniforms.envMap.value}}),i.update(u)),Na.copy(n.backgroundRotation),Na.x*=-1,Na.y*=-1,Na.z*=-1,r.isCubeTexture&&r.isRenderTargetTexture===!1&&(Na.y*=-1,Na.z*=-1),u.material.uniforms.envMap.value=r,u.material.uniforms.flipEnvMap.value=r.isCubeTexture&&r.isRenderTargetTexture===!1?-1:1,u.material.uniforms.backgroundBlurriness.value=n.backgroundBlurriness,u.material.uniforms.backgroundIntensity.value=n.backgroundIntensity,u.material.uniforms.backgroundRotation.value.setFromMatrix4(Pa.makeRotationFromEuler(Na)),u.material.toneMapped=K.getTransfer(r.colorSpace)!==Je,(d!==r||f!==r.version||p!==e.toneMapping)&&(u.material.needsUpdate=!0,d=r,f=r.version,p=e.toneMapping),u.layers.enableAll(),t.unshift(u,u.geometry,u.material,0,0,null)):r&&r.isTexture&&(l===void 0&&(l=new Yr(new Ui(2,2),new oi({name:`BackgroundMaterial`,uniforms:$r(ja.background.uniforms),vertexShader:ja.background.vertexShader,fragmentShader:ja.background.fragmentShader,side:0,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),l.geometry.deleteAttribute(`normal`),Object.defineProperty(l.material,`map`,{get:function(){return this.uniforms.t2D.value}}),i.update(l)),l.material.uniforms.t2D.value=r,l.material.uniforms.backgroundIntensity.value=n.backgroundIntensity,l.material.toneMapped=K.getTransfer(r.colorSpace)!==Je,r.matrixAutoUpdate===!0&&r.updateMatrix(),l.material.uniforms.uvTransform.value.copy(r.matrix),(d!==r||f!==r.version||p!==e.toneMapping)&&(l.material.needsUpdate=!0,d=r,f=r.version,p=e.toneMapping),l.layers.enableAll(),t.unshift(l,l.geometry,l.material,0,0,null))}function _(t,n){t.getRGB(Ma,ni(e)),r.buffers.color.setClear(Ma.r,Ma.g,Ma.b,n,o)}function v(){u!==void 0&&(u.geometry.dispose(),u.material.dispose(),u=void 0),l!==void 0&&(l.geometry.dispose(),l.material.dispose(),l=void 0)}return{getClearColor:function(){return s},setClearColor:function(e,t=1){s.set(e),c=t,_(s,c)},getClearAlpha:function(){return c},setClearAlpha:function(e){c=e,_(s,c)},render:h,addToRenderList:g,dispose:v}}function Ia(e,t){let n=e.getParameter(e.MAX_VERTEX_ATTRIBS),r={},i=f(null),a=i,o=!1;function s(n,r,i,s,c){let u=!1,f=d(s,i,r);a!==f&&(a=f,l(a.object)),u=p(n,s,i,c),u&&m(n,s,i,c),c!==null&&t.update(c,e.ELEMENT_ARRAY_BUFFER),(u||o)&&(o=!1,b(n,r,i,s),c!==null&&e.bindBuffer(e.ELEMENT_ARRAY_BUFFER,t.get(c).buffer))}function c(){return e.createVertexArray()}function l(t){return e.bindVertexArray(t)}function u(t){return e.deleteVertexArray(t)}function d(e,t,n){let i=n.wireframe===!0,a=r[e.id];a===void 0&&(a={},r[e.id]=a);let o=a[t.id];o===void 0&&(o={},a[t.id]=o);let s=o[i];return s===void 0&&(s=f(c()),o[i]=s),s}function f(e){let t=[],r=[],i=[];for(let e=0;e<n;e++)t[e]=0,r[e]=0,i[e]=0;return{geometry:null,program:null,wireframe:!1,newAttributes:t,enabledAttributes:r,attributeDivisors:i,object:e,attributes:{},index:null}}function p(e,t,n,r){let i=a.attributes,o=t.attributes,s=0,c=n.getAttributes();for(let t in c)if(c[t].location>=0){let n=i[t],r=o[t];if(r===void 0&&(t===`instanceMatrix`&&e.instanceMatrix&&(r=e.instanceMatrix),t===`instanceColor`&&e.instanceColor&&(r=e.instanceColor)),n===void 0||n.attribute!==r||r&&n.data!==r.data)return!0;s++}return a.attributesNum!==s||a.index!==r}function m(e,t,n,r){let i={},o=t.attributes,s=0,c=n.getAttributes();for(let t in c)if(c[t].location>=0){let n=o[t];n===void 0&&(t===`instanceMatrix`&&e.instanceMatrix&&(n=e.instanceMatrix),t===`instanceColor`&&e.instanceColor&&(n=e.instanceColor));let r={};r.attribute=n,n&&n.data&&(r.data=n.data),i[t]=r,s++}a.attributes=i,a.attributesNum=s,a.index=r}function h(){let e=a.newAttributes;for(let t=0,n=e.length;t<n;t++)e[t]=0}function g(e){_(e,0)}function _(t,n){let r=a.newAttributes,i=a.enabledAttributes,o=a.attributeDivisors;r[t]=1,i[t]===0&&(e.enableVertexAttribArray(t),i[t]=1),o[t]!==n&&(e.vertexAttribDivisor(t,n),o[t]=n)}function v(){let t=a.newAttributes,n=a.enabledAttributes;for(let r=0,i=n.length;r<i;r++)n[r]!==t[r]&&(e.disableVertexAttribArray(r),n[r]=0)}function y(t,n,r,i,a,o,s){s===!0?e.vertexAttribIPointer(t,n,r,a,o):e.vertexAttribPointer(t,n,r,i,a,o)}function b(n,r,i,a){h();let o=a.attributes,s=i.getAttributes(),c=r.defaultAttributeValues;for(let r in s){let i=s[r];if(i.location>=0){let s=o[r];if(s===void 0&&(r===`instanceMatrix`&&n.instanceMatrix&&(s=n.instanceMatrix),r===`instanceColor`&&n.instanceColor&&(s=n.instanceColor)),s!==void 0){let r=s.normalized,o=s.itemSize,c=t.get(s);if(c===void 0)continue;let l=c.buffer,u=c.type,d=c.bytesPerElement,f=u===e.INT||u===e.UNSIGNED_INT||s.gpuType===1013;if(s.isInterleavedBufferAttribute){let t=s.data,c=t.stride,p=s.offset;if(t.isInstancedInterleavedBuffer){for(let e=0;e<i.locationSize;e++)_(i.location+e,t.meshPerAttribute);n.isInstancedMesh!==!0&&a._maxInstanceCount===void 0&&(a._maxInstanceCount=t.meshPerAttribute*t.count)}else for(let e=0;e<i.locationSize;e++)g(i.location+e);e.bindBuffer(e.ARRAY_BUFFER,l);for(let e=0;e<i.locationSize;e++)y(i.location+e,o/i.locationSize,u,r,c*d,(p+o/i.locationSize*e)*d,f)}else{if(s.isInstancedBufferAttribute){for(let e=0;e<i.locationSize;e++)_(i.location+e,s.meshPerAttribute);n.isInstancedMesh!==!0&&a._maxInstanceCount===void 0&&(a._maxInstanceCount=s.meshPerAttribute*s.count)}else for(let e=0;e<i.locationSize;e++)g(i.location+e);e.bindBuffer(e.ARRAY_BUFFER,l);for(let e=0;e<i.locationSize;e++)y(i.location+e,o/i.locationSize,u,r,o*d,o/i.locationSize*e*d,f)}}else if(c!==void 0){let t=c[r];if(t!==void 0)switch(t.length){case 2:e.vertexAttrib2fv(i.location,t);break;case 3:e.vertexAttrib3fv(i.location,t);break;case 4:e.vertexAttrib4fv(i.location,t);break;default:e.vertexAttrib1fv(i.location,t)}}}}v()}function x(){w();for(let e in r){let t=r[e];for(let e in t){let n=t[e];for(let e in n)u(n[e].object),delete n[e];delete t[e]}delete r[e]}}function S(e){if(r[e.id]===void 0)return;let t=r[e.id];for(let e in t){let n=t[e];for(let e in n)u(n[e].object),delete n[e];delete t[e]}delete r[e.id]}function C(e){for(let t in r){let n=r[t];if(n[e.id]===void 0)continue;let i=n[e.id];for(let e in i)u(i[e].object),delete i[e];delete n[e.id]}}function w(){T(),o=!0,a!==i&&(a=i,l(a.object))}function T(){i.geometry=null,i.program=null,i.wireframe=!1}return{setup:s,reset:w,resetDefaultState:T,dispose:x,releaseStatesOfGeometry:S,releaseStatesOfProgram:C,initAttributes:h,enableAttribute:g,disableUnusedAttributes:v}}function La(e,t,n){let r;function i(e){r=e}function a(t,i){e.drawArrays(r,t,i),n.update(i,r,1)}function o(t,i,a){a!==0&&(e.drawArraysInstanced(r,t,i,a),n.update(i,r,a))}function s(e,i,a){if(a===0)return;t.get(`WEBGL_multi_draw`).multiDrawArraysWEBGL(r,e,0,i,0,a);let o=0;for(let e=0;e<a;e++)o+=i[e];n.update(o,r,1)}function c(e,i,a,s){if(a===0)return;let c=t.get(`WEBGL_multi_draw`);if(c===null)for(let t=0;t<e.length;t++)o(e[t],i[t],s[t]);else{c.multiDrawArraysInstancedWEBGL(r,e,0,i,0,s,0,a);let t=0;for(let e=0;e<a;e++)t+=i[e]*s[e];n.update(t,r,1)}}this.setMode=i,this.render=a,this.renderInstances=o,this.renderMultiDraw=s,this.renderMultiDrawInstances=c}function Ra(e,t,n,r){let i;function a(){if(i!==void 0)return i;if(t.has(`EXT_texture_filter_anisotropic`)===!0){let n=t.get(`EXT_texture_filter_anisotropic`);i=e.getParameter(n.MAX_TEXTURE_MAX_ANISOTROPY_EXT)}else i=0;return i}function o(t){return!(t!==1023&&r.convert(t)!==e.getParameter(e.IMPLEMENTATION_COLOR_READ_FORMAT))}function s(n){let i=n===1016&&(t.has(`EXT_color_buffer_half_float`)||t.has(`EXT_color_buffer_float`));return!(n!==1009&&r.convert(n)!==e.getParameter(e.IMPLEMENTATION_COLOR_READ_TYPE)&&n!==1015&&!i)}function c(t){if(t===`highp`){if(e.getShaderPrecisionFormat(e.VERTEX_SHADER,e.HIGH_FLOAT).precision>0&&e.getShaderPrecisionFormat(e.FRAGMENT_SHADER,e.HIGH_FLOAT).precision>0)return`highp`;t=`mediump`}return t===`mediump`&&e.getShaderPrecisionFormat(e.VERTEX_SHADER,e.MEDIUM_FLOAT).precision>0&&e.getShaderPrecisionFormat(e.FRAGMENT_SHADER,e.MEDIUM_FLOAT).precision>0?`mediump`:`lowp`}let l=n.precision===void 0?`highp`:n.precision,u=c(l);u!==l&&(console.warn(`THREE.WebGLRenderer:`,l,`not supported, using`,u,`instead.`),l=u);let d=n.logarithmicDepthBuffer===!0,f=n.reversedDepthBuffer===!0&&t.has(`EXT_clip_control`),p=e.getParameter(e.MAX_TEXTURE_IMAGE_UNITS),m=e.getParameter(e.MAX_VERTEX_TEXTURE_IMAGE_UNITS),h=e.getParameter(e.MAX_TEXTURE_SIZE),g=e.getParameter(e.MAX_CUBE_MAP_TEXTURE_SIZE),_=e.getParameter(e.MAX_VERTEX_ATTRIBS),v=e.getParameter(e.MAX_VERTEX_UNIFORM_VECTORS),y=e.getParameter(e.MAX_VARYING_VECTORS),b=e.getParameter(e.MAX_FRAGMENT_UNIFORM_VECTORS),x=m>0,S=e.getParameter(e.MAX_SAMPLES);return{isWebGL2:!0,getMaxAnisotropy:a,getMaxPrecision:c,textureFormatReadable:o,textureTypeReadable:s,precision:l,logarithmicDepthBuffer:d,reversedDepthBuffer:f,maxTextures:p,maxVertexTextures:m,maxTextureSize:h,maxCubemapSize:g,maxAttributes:_,maxVertexUniforms:v,maxVaryings:y,maxFragmentUniforms:b,vertexTextures:x,maxSamples:S}}function za(e){let t=this,n=null,r=0,i=!1,a=!1,o=new wi,s=new G,c={value:null,needsUpdate:!1};this.uniform=c,this.numPlanes=0,this.numIntersection=0,this.init=function(e,t){let n=e.length!==0||t||r!==0||i;return i=t,r=e.length,n},this.beginShadows=function(){a=!0,u(null)},this.endShadows=function(){a=!1},this.setGlobalState=function(e,t){n=u(e,t,0)},this.setState=function(t,o,s){let d=t.clippingPlanes,f=t.clipIntersection,p=t.clipShadows,m=e.get(t);if(!i||d===null||d.length===0||a&&!p)a?u(null):l();else{let e=a?0:r,t=e*4,i=m.clippingState||null;c.value=i,i=u(d,o,t,s);for(let e=0;e!==t;++e)i[e]=n[e];m.clippingState=i,this.numIntersection=f?this.numPlanes:0,this.numPlanes+=e}};function l(){c.value!==n&&(c.value=n,c.needsUpdate=r>0),t.numPlanes=r,t.numIntersection=0}function u(e,n,r,i){let a=e===null?0:e.length,l=null;if(a!==0){if(l=c.value,i!==!0||l===null){let t=r+a*4,i=n.matrixWorldInverse;s.getNormalMatrix(i),(l===null||l.length<t)&&(l=new Float32Array(t));for(let t=0,n=r;t!==a;++t,n+=4)o.copy(e[t]).applyMatrix4(i,s),o.normal.toArray(l,n),l[n+3]=o.constant}c.value=l,c.needsUpdate=!0}return t.numPlanes=a,t.numIntersection=0,l}}function Ba(e){let t=new WeakMap;function n(e,t){return t===303?e.mapping=301:t===304&&(e.mapping=302),e}function r(r){if(r&&r.isTexture){let a=r.mapping;if(a===303||a===304)if(t.has(r)){let e=t.get(r).texture;return n(e,r.mapping)}else{let a=r.image;if(a&&a.height>0){let o=new gi(a.height);return o.fromEquirectangularTexture(e,r),t.set(r,o),r.addEventListener(`dispose`,i),n(o.texture,r.mapping)}else return null}}return r}function i(e){let n=e.target;n.removeEventListener(`dispose`,i);let r=t.get(n);r!==void 0&&(t.delete(n),r.dispose())}function a(){t=new WeakMap}return{get:r,dispose:a}}var Va=4,Ha=[.125,.215,.35,.446,.526,.582],Ua=20,Wa=new ca,Ga=new q,Ka=null,qa=0,Ja=0,Ya=!1,Xa=(1+Math.sqrt(5))/2,Za=1/Xa,Qa=[new W(-Xa,Za,0),new W(Xa,Za,0),new W(-Za,0,Xa),new W(Za,0,Xa),new W(0,Xa,-Za),new W(0,Xa,Za),new W(-1,1,-1),new W(1,1,-1),new W(-1,1,1),new W(1,1,1)],$a=new W,eo=class{constructor(e){this._renderer=e,this._pingPongRenderTarget=null,this._lodMax=0,this._cubeSize=0,this._lodPlanes=[],this._sizeLods=[],this._sigmas=[],this._blurMaterial=null,this._cubemapMaterial=null,this._equirectMaterial=null,this._compileMaterial(this._blurMaterial)}fromScene(e,t=0,n=.1,r=100,i={}){let{size:a=256,position:o=$a}=i;Ka=this._renderer.getRenderTarget(),qa=this._renderer.getActiveCubeFace(),Ja=this._renderer.getActiveMipmapLevel(),Ya=this._renderer.xr.enabled,this._renderer.xr.enabled=!1,this._setSize(a);let s=this._allocateTargets();return s.depthBuffer=!0,this._sceneToCubeUV(e,n,r,s,o),t>0&&this._blur(s,0,0,t),this._applyPMREM(s),this._cleanup(s),s}fromEquirectangular(e,t=null){return this._fromTexture(e,t)}fromCubemap(e,t=null){return this._fromTexture(e,t)}compileCubemapShader(){this._cubemapMaterial===null&&(this._cubemapMaterial=oo(),this._compileMaterial(this._cubemapMaterial))}compileEquirectangularShader(){this._equirectMaterial===null&&(this._equirectMaterial=ao(),this._compileMaterial(this._equirectMaterial))}dispose(){this._dispose(),this._cubemapMaterial!==null&&this._cubemapMaterial.dispose(),this._equirectMaterial!==null&&this._equirectMaterial.dispose()}_setSize(e){this._lodMax=Math.floor(Math.log2(e)),this._cubeSize=2**this._lodMax}_dispose(){this._blurMaterial!==null&&this._blurMaterial.dispose(),this._pingPongRenderTarget!==null&&this._pingPongRenderTarget.dispose();for(let e=0;e<this._lodPlanes.length;e++)this._lodPlanes[e].dispose()}_cleanup(e){this._renderer.setRenderTarget(Ka,qa,Ja),this._renderer.xr.enabled=Ya,e.scissorTest=!1,ro(e,0,0,e.width,e.height)}_fromTexture(e,t){e.mapping===301||e.mapping===302?this._setSize(e.image.length===0?16:e.image[0].width||e.image[0].image.width):this._setSize(e.image.width/4),Ka=this._renderer.getRenderTarget(),qa=this._renderer.getActiveCubeFace(),Ja=this._renderer.getActiveMipmapLevel(),Ya=this._renderer.xr.enabled,this._renderer.xr.enabled=!1;let n=t||this._allocateTargets();return this._textureToCubeUV(e,n),this._applyPMREM(n),this._cleanup(n),n}_allocateTargets(){let e=3*Math.max(this._cubeSize,112),t=4*this._cubeSize,n={magFilter:x,minFilter:x,generateMipmaps:!1,type:j,format:ie,colorSpace:Ke,depthBuffer:!1},r=no(e,t,n);if(this._pingPongRenderTarget===null||this._pingPongRenderTarget.width!==e||this._pingPongRenderTarget.height!==t){this._pingPongRenderTarget!==null&&this._dispose(),this._pingPongRenderTarget=no(e,t,n);let{_lodMax:r}=this;({sizeLods:this._sizeLods,lodPlanes:this._lodPlanes,sigmas:this._sigmas}=to(r)),this._blurMaterial=io(r,e,t)}return r}_compileMaterial(e){let t=new Yr(this._lodPlanes[0],e);this._renderer.compile(t,Wa)}_sceneToCubeUV(e,t,n,r,i){let a=new di(90,1,t,n),o=[1,-1,1,1,1,1],s=[1,1,1,-1,-1,-1],c=this._renderer,l=c.autoClear,u=c.toneMapping;c.getClearColor(Ga),c.toneMapping=0,c.autoClear=!1,c.state.buffers.depth.getReversed()&&(c.setRenderTarget(r),c.clearDepth(),c.setRenderTarget(null));let d=new Sr({name:`PMREM.Background`,side:1,depthWrite:!1,depthTest:!1}),f=new Yr(new Qr,d),p=!1,m=e.background;m?m.isColor&&(d.color.copy(m),e.background=null,p=!0):(d.color.copy(Ga),p=!0);for(let t=0;t<6;t++){let n=t%3;n===0?(a.up.set(0,o[t],0),a.position.set(i.x,i.y,i.z),a.lookAt(i.x+s[t],i.y,i.z)):n===1?(a.up.set(0,0,o[t]),a.position.set(i.x,i.y,i.z),a.lookAt(i.x,i.y+s[t],i.z)):(a.up.set(0,o[t],0),a.position.set(i.x,i.y,i.z),a.lookAt(i.x,i.y,i.z+s[t]));let l=this._cubeSize;ro(r,n*l,t>2?l:0,l,l),c.setRenderTarget(r),p&&c.render(f,a),c.render(e,a)}f.geometry.dispose(),f.material.dispose(),c.toneMapping=u,c.autoClear=l,e.background=m}_textureToCubeUV(e,t){let n=this._renderer,r=e.mapping===301||e.mapping===302;r?(this._cubemapMaterial===null&&(this._cubemapMaterial=oo()),this._cubemapMaterial.uniforms.flipEnvMap.value=e.isRenderTargetTexture===!1?-1:1):this._equirectMaterial===null&&(this._equirectMaterial=ao());let i=r?this._cubemapMaterial:this._equirectMaterial,a=new Yr(this._lodPlanes[0],i),o=i.uniforms;o.envMap.value=e;let s=this._cubeSize;ro(t,0,0,3*s,2*s),n.setRenderTarget(t),n.render(a,Wa)}_applyPMREM(e){let t=this._renderer,n=t.autoClear;t.autoClear=!1;let r=this._lodPlanes.length;for(let t=1;t<r;t++){let n=Math.sqrt(this._sigmas[t]*this._sigmas[t]-this._sigmas[t-1]*this._sigmas[t-1]),i=Qa[(r-t-1)%Qa.length];this._blur(e,t-1,t,n,i)}t.autoClear=n}_blur(e,t,n,r,i){let a=this._pingPongRenderTarget;this._halfBlur(e,a,t,n,r,`latitudinal`,i),this._halfBlur(a,e,n,n,r,`longitudinal`,i)}_halfBlur(e,t,n,r,i,a,o){let s=this._renderer,c=this._blurMaterial;a!==`latitudinal`&&a!==`longitudinal`&&console.error(`blur direction must be either latitudinal or longitudinal!`);let l=new Yr(this._lodPlanes[r],c),u=c.uniforms,d=this._sizeLods[n]-1,f=isFinite(i)?Math.PI/(2*d):2*Math.PI/(2*Ua-1),p=i/f,m=isFinite(i)?1+Math.floor(3*p):Ua;m>Ua&&console.warn(`sigmaRadians, ${i}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${Ua}`);let h=[],g=0;for(let e=0;e<Ua;++e){let t=e/p,n=Math.exp(-t*t/2);h.push(n),e===0?g+=n:e<m&&(g+=2*n)}for(let e=0;e<h.length;e++)h[e]=h[e]/g;u.envMap.value=e.texture,u.samples.value=m,u.weights.value=h,u.latitudinal.value=a===`latitudinal`,o&&(u.poleAxis.value=o);let{_lodMax:_}=this;u.dTheta.value=f,u.mipInt.value=_-n;let v=this._sizeLods[r];ro(t,3*v*(r>_-Va?r-_+Va:0),4*(this._cubeSize-v),3*v,2*v),s.setRenderTarget(t),s.render(l,Wa)}};function to(e){let t=[],n=[],r=[],i=e,a=e-Va+1+Ha.length;for(let o=0;o<a;o++){let a=2**i;n.push(a);let s=1/a;o>e-Va?s=Ha[o-e+Va-1]:o===0&&(s=0),r.push(s);let c=1/(a-2),l=-c,u=1+c,d=[l,l,u,l,u,u,l,l,u,u,l,u],f=new Float32Array(108),p=new Float32Array(72),m=new Float32Array(36);for(let e=0;e<6;e++){let t=e%3*2/3-1,n=e>2?0:-1,r=[t,n,0,t+2/3,n,0,t+2/3,n+1,0,t,n,0,t+2/3,n+1,0,t,n+1,0];f.set(r,18*e),p.set(d,12*e);let i=[e,e,e,e,e,e];m.set(i,6*e)}let h=new Lr;h.setAttribute(`position`,new Er(f,3)),h.setAttribute(`uv`,new Er(p,2)),h.setAttribute(`faceIndex`,new Er(m,1)),t.push(h),i>Va&&i--}return{lodPlanes:t,sizeLods:n,sigmas:r}}function no(e,t,n){let r=new Xt(e,t,n);return r.texture.mapping=306,r.texture.name=`PMREM.cubeUv`,r.scissorTest=!0,r}function ro(e,t,n,r,i){e.viewport.set(t,n,r,i),e.scissor.set(t,n,r,i)}function io(e,t,n){let r=new Float32Array(Ua),i=new W(0,1,0);return new oi({name:`SphericalGaussianBlur`,defines:{n:Ua,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:so(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ao(){return new oi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:so(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function oo(){return new oi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:so(),fragmentShader:`
...
`)}function js(e,t){let n;switch(t){case 1:n=`Linear`;break;case 2:n=`Reinhard`;break;case 3:n=`Cineon`;break;case 4:n=`ACESFilmic`;break;case 6:n=`AgX`;break;case 7:n=`Neutral`;break;case 5:n=`Custom`;break;default:console.warn(`THREE.WebGLProgram: Unsupported toneMapping:`,t),n=`Linear`}return`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Ms=new W;function Ns(){return K.getLuminanceCoefficients(Ms),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Ms.x.toFixed(4)}, ${Ms.y.toFixed(4)}, ${Ms.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
#define LOW_PRECISION`),t}function Js(e){let t=`SHADOWMAP_TYPE_BASIC`;return e.shadowMapType===1?t=`SHADOWMAP_TYPE_PCF`:e.shadowMapType===2?t=`SHADOWMAP_TYPE_PCF_SOFT`:e.shadowMapType===3&&(t=`SHADOWMAP_TYPE_VSM`),t}function Ys(e){let t=`ENVMAP_TYPE_CUBE`;if(e.envMap)switch(e.envMapMode){case 301:case 302:t=`ENVMAP_TYPE_CUBE`;break;case 306:t=`ENVMAP_TYPE_CUBE_UV`;break}return t}function Xs(e){let t=`ENVMAP_MODE_REFLECTION`;if(e.envMap)switch(e.envMapMode){case 302:t=`ENVMAP_MODE_REFRACTION`;break}return t}function Zs(e){let t=`ENVMAP_BLENDING_NONE`;if(e.envMap)switch(e.combine){case 0:t=`ENVMAP_BLENDING_MULTIPLY`;break;case 1:t=`ENVMAP_BLENDING_MIX`;break;case 2:t=`ENVMAP_BLENDING_ADD`;break}return t}function Qs(e){let t=e.envMapCubeUVHeight;if(t===null)return null;let n=Math.log2(t)-2,r=1/t;return{texelWidth:1/(3*Math.max(2**n,112)),texelHeight:r,maxMip:n}}function $s(e,t,n,r){let i=e.getContext(),a=n.defines,o=n.vertexShader,s=n.fragmentShader,c=Js(n),l=Ys(n),u=Xs(n),d=Zs(n),f=Qs(n),p=Ps(n),m=Fs(a),h=i.createProgram(),g,_,v=n.glslVersion?`#version `+n.glslVersion+`
...
vec3 base=texture2D(earth,uv).rgb;int index=int(clamp(vLevel,0.0,17.0));vec3 levelColor=palette[index];base=mix(base,levelColor*0.64,mode);
...
#include <tonemapping_fragment>
#include <colorspace_fragment>
}`;function nf(t,n=null,i=new Map){let a=[],o=[],s=[],c=[],l=[],u=[];for(let d of t){let t=l.length,f=a.length/3,p=i.get(d.id);function m(t,n,i=1){let l=r(d.face,d.u+t*d.size,d.v+n*d.size);if(a.push(...l.map(e=>e*i)),o.push(t,n),p?.projection===2){let{lat:t,lon:n}=e(l),r=p.bounds;s.push((n-r.west+360)%360/r.span,(1-Wd(t)-r.south)/r.height)}else s.push(0,0);c.push(d.level)}for(let e=0;e<=Qd;e++)for(let t=0;t<=Qd;t++)m(t/Qd,e/Qd);for(let e=0;e<Qd;e++)for(let t=0;t<Qd;t++){let n=f+e*(Qd+1)+t,r=n+1,i=n+Qd+1,a=i+1;l.push(n,r,i,r,a,i)}let h=[];for(let e=0;e<Qd;e++)h.push([e/Qd,0]);for(let e=0;e<Qd;e++)h.push([1,e/Qd]);for(let e=Qd;e>0;e--)h.push([e/Qd,1]);for(let e=Qd;e>0;e--)h.push([0,e/Qd]);let g=a.length/3,_=Math.max(3e-6,d.size*d.size*.008);for(let[e,t]of h)m(e,t),m(e,t,1-_);for(let e=0;e<h.length;e++){let t=g+e*2,n=g+(e+1)%h.length*2;l.push(t,t+1,n,n,t+1,n+1)}if(n){let e=n.get(d.id),r=u[u.length-1];r&&r.materialIndex===e?r.count+=l.length-t:u.push({start:t,count:l.length-t,materialIndex:e})}}let d=new Lr;d.setAttribute(`position`,new kr(a,3)),d.setAttribute(`tileUV`,new kr(o,2)),d.setAttribute(`imageUV`,new kr(s,2)),d.setAttribute(`level`,new kr(c,1)),d.setIndex(l);for(let e of u)d.addGroup(e.start,e.count,e.materialIndex);return d.computeBoundingSphere(),d}var rf=class{constructor(e,r,i){Object.assign(this,{container:e,onUpdate:r,onError:i,disposed:!1,roots:Array.from({length:6},(e,t)=>new n(t)),split:new Set,leaves:[],signature:``,detail:45,selection:null,lastBuild:0,lastStats:0,dirty:!0,flight:null}),this.scene=new bi,this.camera=new di(42,1,5e-6,30),this.setCamera(28,110,14e3),this.renderer=new jc({antialias:!0,alpha:!0,powerPreference:`high-performance`}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,1.75)),this.renderer.setClearColor(527893,0),this.renderer.outputColorSpace=Ge;let o=this.renderer.domElement;o.setAttribute(`aria-label`,`交互地球：方向键旋转，加减键缩放；鼠标拖动旋转，点击查看图块`),o.tabIndex=0,e.appendChild(o),this.controls=new Vc(this.camera,o),this.controls.enablePan=!1,this.controls.enableDamping=!0,this.controls.dampingFactor=.09,this.controls.minDistance=1+f/t,this.controls.maxDistance=1+a/t,this.controls.addEventListener(`change`,()=>{this.dirty=!0}),this.controls.addEventListener(`start`,()=>{this.flight=null}),this.texture=$d(),this.texture.anisotropy=this.renderer.capabilities.getMaxAnisotropy(),this.material=new oi({vertexShader:ef,fragmentShader:tf,uniforms:{earth:{value:this.texture},satellite:{value:0},imageBounds:{value:new Jt(-180,-90,360,180)},grid:{value:1},mode:{value:0},eye:{value:this.camera.position},palette:{value:d.map(e=>new q(e))}},side:2}),this.mesh=new Yr(new Lr,this.material),this.imagery=new Zd(()=>{this.dirty=!0}),this.mesh.frustumCulled=!1,this.scene.add(this.mesh),this.selectionLine=new zi(new Lr,new ki({color:16765077,depthTest:!1,transparent:!0,opacity:.95})),this.selectionLine.visible=!1,this.selectionLine.renderOrder=3,this.scene.add(this.selectionLine),this.frustum=new Oi,this.matrix=new Dn,this.bound=new vn,this.raycaster=new Sa,this.down=null,this.pointerDown=e=>{this.down=[e.clientX,e.clientY]},this.pointerUp=e=>{this.down&&Math.hypot(e.clientX-this.down[0],e.clientY-this.down[1])<5&&this.pick(e),this.down=null},this.contextLost=e=>{e.preventDefault(),this.onError(`图形上下文已中断，请刷新页面恢复地球。`)},this.keyDown=e=>{if([`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`+`,`=`,`-`].includes(e.key))e.preventDefault();else return;if([`+`,`=`,`-`].includes(e.key)){this.zoomBy(e.key===`-`?1.35:.75);return}let{lat:n,lon:r}=this.location(),i=Math.min(3,this.altitude()/t*180/Math.PI*.25);this.flyTo(Math.max(-85,Math.min(85,n+(e.key===`ArrowUp`?i:e.key===`ArrowDown`?-i:0))),r+(e.key===`ArrowRight`?i:e.key===`ArrowLeft`?-i:0),this.altitude())},o.addEventListener(`pointerdown`,this.pointerDown),o.addEventListener(`pointerup`,this.pointerUp),o.addEventListener(`keydown`,this.keyDown),o.addEventListener(`webglcontextlost`,this.contextLost),this.resize=new ResizeObserver(()=>{let t=e.clientWidth,n=e.clientHeight;!t||!n||(this.camera.aspect=t/n,this.camera.updateProjectionMatrix(),this.renderer.setSize(t,n),this.dirty=!0)}),this.resize.observe(e),this.tick=this.tick.bind(this),this.frame=requestAnimationFrame(this.tick)}setCamera(e,n,r){this.camera.position.fromArray(c(e,n,1+r/t)),this.camera.lookAt(0,0,0)}location(){return e(this.camera.position.toArray())}altitude(){return(this.camera.position.length()-1)*t}setZoom(e){this.flight=null,this.camera.position.setLength(1+Math.max(f,Math.min(a,e))/t),this.controls.update(),this.dirty=!0}zoomBy(e){let{lat:t,lon:n}=this.location();this.flyTo(t,n,this.altitude()*e)}setMode(e){this.material.uniforms.mode.value=+(e===`levels`)}setGrid(e){this.material.uniforms.grid.value=+!!e}retryImagery(){this.imagery.retry(),this.hdImagery?.retry()}async enableMapTiler(e){this.keyRequest?.abort();let t=new AbortController;this.keyRequest=t;let n=setTimeout(()=>t.abort(),15e3);try{let n=await Jd(e.trim(),t.signal);if(t.signal.throwIfAborted(),this.disposed)return;this.hdImagery?.dispose(),this.hdImagery=new Zd(()=>{this.dirty=!0},Xd(e.trim(),n),128,{maxLevel:16,source:Ud,resolutionMeters:2}),this.signature=``,this.dirty=!0}catch(e){throw e.name===`AbortError`?Error(`连接超时或已取消，请重试。`):e}finally{clearTimeout(n)}}useEOX(){this.keyRequest?.abort(),this.hdImagery?.dispose(),this.hdImagery=null,this.signature=``,this.dirty=!0}flyTo(e,n,r){let i=new W(...c(e,n));this.flight={start:performance.now(),from:this.camera.position.clone(),rotation:new Tt().setFromUnitVectors(this.camera.position.clone().normalize(),i),radius:1+Math.max(f,Math.min(a,r))/t},window.matchMedia(`(prefers-reduced-motion: reduce)`).matches&&(this.setCamera(e,n,Math.max(f,Math.min(a,r))),this.flight=null,this.dirty=!0)}pick(e){let t=this.renderer.domElement.getBoundingClientRect();this.raycaster.setFromCamera(new U((e.clientX-t.left)/t.width*2-1,-(e.clientY-t.top)/t.height*2+1),this.camera);let n=this.raycaster.ray.intersectSphere(new vn(new W,1),new W);this.selection=n?l(n.toArray()):null,this.updateSelection(),this.lastStats=0}selectedTile(){if(!this.selection)return null;let{face:e,u:t,v:n}=this.selection;return this.leaves.find(r=>r.face===e&&t>=r.u-1e-9&&t<=r.u+r.size+1e-9&&n>=r.v-1e-9&&n<=r.v+r.size+1e-9)||null}updateSelection(){let e=this.selectedTile();if(this.selectionLine.visible=!!e,!e)return;let t=[];for(let n=0;n<4;n++)for(let i=0;i<24;i++){let a=i/24,[o,s]=[[a,0],[1,a],[1-a,1],[0,1-a]][n];t.push(new W(...r(e.face,e.u+o*e.size,e.v+s*e.size)).multiplyScalar(1.00002))}this.selectionLine.geometry.dispose(),this.selectionLine.geometry=new Lr().setFromPoints(t)}rebuild(){this.camera.updateMatrixWorld(),this.matrix.multiplyMatrices(this.camera.projectionMatrix,this.camera.matrixWorldInverse),this.frustum.setFromProjectionMatrix(this.matrix);let e=this.container.clientHeight/(2*Math.tan(wt.degToRad(this.camera.fov)/2)),t=260*(50/260)**(this.detail/100),n=o(this.roots,this.camera.position.toArray(),e,t,e=>(this.bound.center.fromArray(e.center),this.bound.radius=e.radius,this.frustum.intersectsSphere(this.bound)),this.split);this.split=n.split,this.leaves=n.leaves,this.hdImagery?.update(this.leaves),this.imagery.update(this.leaves.filter(e=>!this.hdImagery?.resolve(e)));let r=new Map;for(let e of this.leaves){let t=this.hdImagery?.resolve(e),n=t||this.imagery.resolve(e),i=n?(t?`hd:`:`eox:`)+n.id:`outline`;r.has(i)||r.set(i,{entry:n,tiles:[]}),r.get(i).tiles.push(e)}let i=[...r].map(([e,t])=>e+`:`+t.tiles.map(e=>e.id).join(`,`)).join(`|`);if(i!==this.signature){this.signature=i;let e=[],t=new Map,n=new Map,a=[];for(let{entry:i,tiles:o}of r.values()){if(i&&!i.material){let e=i.asset.bounds;i.material=new oi({vertexShader:ef,fragmentShader:tf,uniforms:{...this.material.uniforms,earth:{value:i.asset.texture},satellite:{value:i.asset.projection||1},imageBounds:{value:new Jt(e.west,e.south,e.span,e.height)}},side:2}),i.asset.texture.anisotropy=Math.min(4,this.renderer.capabilities.getMaxAnisotropy())}let r=e.length;e.push(i?.material||this.material);for(let e of o)a.push(e),t.set(e.id,r),i&&n.set(e.id,i.asset)}let o=nf(a,t,n);this.mesh.geometry.dispose(),this.mesh.geometry=o,this.mesh.material=e,this.updateSelection()}}tick(e){if(!this.disposed){if(this.flight){let t=this.flight,n=Math.min(1,(e-t.start)/1200),r=n*n*(3-2*n),i=t.from.clone().normalize().applyQuaternion(new Tt().slerp(t.rotation,r)),a=Math.exp(Math.log(t.from.length()-1)*(1-r)+Math.log(t.radius-1)*r)+1;this.camera.position.copy(i.multiplyScalar(a)),this.dirty=!0,n===1&&(this.flight=null)}if(this.controls.rotateSpeed=Math.max(1e-4,Math.min(.65,(this.camera.position.length()-1)*.32)),this.controls.zoomSpeed=Math.min(1,3*(this.camera.position.length()-1)/this.camera.position.length()),this.controls.update(),this.dirty&&e-this.lastBuild>65&&(this.rebuild(),this.lastBuild=e,this.dirty=!1),this.renderer.render(this.scene,this.camera),e-this.lastStats>180){let t=Array(18).fill(0);for(let e of this.leaves)t[e.level]++;let n=this.leaves.map(e=>e.level),r=this.selectedTile();this.onUpdate({count:this.leaves.length,min:n.length?Math.min(...n):0,max:n.length?Math.max(...n):0,altitude:this.altitude(),...this.location(),histogram:t,imagery:(this.hdImagery||this.imagery).stats(),triangles:this.mesh.geometry.index?this.mesh.geometry.index.count/3:0,selected:r?{id:r.id,level:r.level,face:r.face,x:r.x,y:r.y}:null}),this.lastStats=e}this.frame=requestAnimationFrame(this.tick)}}dispose(){this.disposed=!0,cancelAnimationFrame(this.frame),this.resize.disconnect(),this.controls.dispose();let e=this.renderer.domElement;e.removeEventListener(`pointerdown`,this.pointerDown),e.removeEventListener(`pointerup`,this.pointerUp),e.removeEventListener(`keydown`,this.keyDown),e.removeEventListener(`webglcontextlost`,this.contextLost),this.mesh.geometry.dispose(),this.imagery.dispose(),this.keyRequest?.abort(),this.hdImagery?.dispose(),this.material.dispose(),this.texture.dispose(),this.selectionLine.geometry.dispose(),this.selectionLine.material.dispose(),this.renderer.dispose(),e.remove()}};export{rf as Globe};